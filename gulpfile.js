...
// copy json from app/src to app/dist/
...
gulp.task('dev', function (cb) {
    runSequence(['clean-files'], ['publish-json','publish-fonts', 'publish-images', 'publish-audios', 'publish-css', 'publish-js'], 'inject', 'watch', cb);
});
